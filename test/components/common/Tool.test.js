...
import Tool from "./../../../src/js/components/common/Tool.react";
...
describe("<Tool />", () => {
	...
	const mockThreat = {
		id: "5gp7cItVvUKsqmYgWW2dev",
		slug: "development",
		name: "Development",
		shortDescription: "Development",
		longDescription: "Development.",
		stats: "Development.",
	...
	const mockTool = {
		...
		name: "Mock Tool",
		headline: "Mock Tool for Testing",
	...
	test("details button respods to clicks", () => {
        fireEvent.click(getByTitle(mockTool.headline));
        expect(mockGoToPage).toHaveBeenCalledTimes(1);
        expect(mockGoToPage).toHaveBeenCalledWith(routes.getUriOverlayTool(mockTool.slug), true, true);
	});
});
